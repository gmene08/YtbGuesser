...
app.put('/api/engine/lobby/:roomCode', (req,res)=>{
 ...
 const updatedLobby = {
    ...
    //Lobby no frontend nao recebe match, mas como damos set nos novos dados do lobby, precisamos garantir que o match atual nao seja perdido. Provavelmente seria melhor espelhar o DTO do lobby no frontend pra nao mandar dados desnecessários, mas acabei fazendo assim na correria. Fica de melhoria futura
