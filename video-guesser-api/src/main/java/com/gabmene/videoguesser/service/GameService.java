...
public class GameService {
    ...
    @Transactional
    public MatchResponseDTO processEngineReport(EngineRoundReportDTO report, String roomCode) {
        System.out.println("Processing engine report for room " + roomCode);
        Round currentRound = roundRepository.findCurrentRoundByRoomCode(roomCode)
                .orElseThrow(() -> new ResourceNotFoundException("Active round not found for room " + roomCode));
